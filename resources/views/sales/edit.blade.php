...
<div class="flex-1 overflow-auto ml-64">
    <div class="bg-white shadow-sm border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <h1 class="text-2xl font-bold text-gray-800">
                <i class="fas fa-edit mr-2 text-blue-500"></i>Edit Sale
            </h1>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <form action="{{ route('sales.update', $sale) }}" method="POST" class="p-6" id="edit-form">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-2">
                        ...
                        <input type="number" name="qty" id="qty" value="{{ old('qty', $sale->qty) }}" 
                    ...
                    <div class="col-span-6 sm:col-span-2">
                        ...
                        <input type="number" step="0.01" name="price" id="price" value="{{ old('price', $sale->price) }}" 
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div class="col-span-6 sm:col-span-2">
                        ...
                        <input type="date" name="date" id="date" value="{{ old('date', $sale->date->format('Y-m-d')) }}" 
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
...
document.getElementById('edit-form').addEventListener('submit', function(e) {
    ...
    Swal.fire({
        ...
        text: "Are you sure you want to update this sale?",
        icon: 'question',
