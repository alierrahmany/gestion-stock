...
<div class="flex-1 overflow-auto ml-64">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden border-l-4 border-indigo-500">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Total Achats Produits</dt>
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">{{ number_format($stats['total_products_purchased']) }}</div>
            ...
            <!-- Total Products Purchases Amount -->
            <div class="bg-white shadow rounded-lg overflow-hidden border-l-4 border-purple-500">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Valeur Totale Achats</dt>
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">{{ number_format($stats['total_products_purchases_amount'], 2) }} MAD</div>
                                </dd>
                            </dl>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 gap-6 mb-6">
            <div class="bg-white shadow rounded-lg overflow-hidden">
                <div class="border-b border-gray-200 px-6 py-4 bg-purple-50">
                    <h3 class="text-lg font-medium text-gray-900">Top 3 Fournisseurs Actifs (Tous le temps)</h3>
                </div>
                <div class="divide-y divide-gray-200">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-sm text-gray-500">Produits livrés: {{ $supplier->total_delivered }}</p>
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-sm text-gray-500">Catégorie: {{ $item->product->categorie->name ?? 'Non classé' }}</p>
                                </div>
                            </div>
                            <div>
