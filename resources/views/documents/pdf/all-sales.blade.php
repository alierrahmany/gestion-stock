...
<html>
<head>
    <title>All Sales Orders - {{ now()->format('Y-m-d') }}</title>
    <style>
        body {
...
<body>
    ...
    @foreach($sales as $index => $sale)
        <div class="document">
            <table>
                <tr>
                    <td width="50%"><strong>Sales Order #:</strong> SO-{{ str_pad($sale->id, 5, '0', STR_PAD_LEFT) }}</td>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="3" style="text-align: right;"><strong>Tax ({{ $sale->tax_rate ?? 0 }}%):</strong></td>
