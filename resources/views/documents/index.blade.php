        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h2 class="text-xl font-semibold text-gray-800">
                            <i class="fas fa-truck mr-2 text-blue-500"></i>Delivery Notes
                        </h2>
                    ...
                    <p class="text-gray-600 mb-4">Manage all delivery notes (Bon de Livraison) for client orders.</p>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow p-6">
                    ...
                    <p class="text-gray-600 mb-4">Manage all purchase orders (Bon d'Achat) from suppliers.</p>
                    <div class="flex space-x-2">
                        <a href="{{ route('documents.purchases') }}" 
